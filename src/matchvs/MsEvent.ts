...
module mvs {
    export class MsEvent {
        ...
        public static EVENT_SETFRAMESYNC_NTFY = "MATCHVS_SETFRAMESYNC_NTFY_EVENT";
        ...
        //断线重连时间
        public static EVENT_SETRECONNECTTIMEOUT_RSP = "MATCHVS_SETRECONNECTTIMEOUT_RSP_EVENT";
        //断线期间帧数据
        public static EVENT_GETOFFLINEDATA_RSP = "MATCHVS_GETOFFLINEDATA_RSP_EVENT";
